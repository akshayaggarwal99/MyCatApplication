...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
     ...
     * (@bodyType is the ResponseType. It can be AllCatFactsResponse)
     *
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        // Check #2
        // Type that LiveData is wrapping - <T>
        ...
        // FYI: T is AllCatFactsResponse in this app. But T can be anything theoretically.
        if(!(observableType instanceof ParameterizedType)){
            throw new IllegalArgumentException("resource must be parameterized");
        }

        // get the Response type. (AllCatFactsResponse)
